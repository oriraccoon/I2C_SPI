...
set_property -dict { PACKAGE_PIN H1   IOSTANDARD LVCMOS33 } [get_ports {o_state[0]}];#Sch name = JA7
set_property -dict { PACKAGE_PIN K2   IOSTANDARD LVCMOS33 } [get_ports {o_state[1]}];#Sch name = JA8
set_property -dict { PACKAGE_PIN H2   IOSTANDARD LVCMOS33 } [get_ports {o_state[2]}];#Sch name = JA9
set_property -dict { PACKAGE_PIN G3   IOSTANDARD LVCMOS33 } [get_ports {o_state[3]}];#Sch name = JA10
